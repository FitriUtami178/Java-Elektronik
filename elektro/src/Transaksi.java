...
public class Transaksi extends javax.swing.JFrame {
  ...
  private void nofaktur() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(ttotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 130, 30));
        ...
        jPanel1.add(hitung, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 80, 30));
        ...
        jPanel1.add(tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 350, 330, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 540, 100));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 80, 320, 430));
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 390, -1, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try{
            Desktop.getDesktop().browse(new URL("http://localhost/print/invoice.php?lap&fk="+jTextField2.getText()+"").toURI());
        } catch (Exception e){
            ...
            if(ab < 0){
                ...
                try {
                    ...
                    while (r.next()) {
                        ...
                        p.setString(2, r.getString("nama_barang"));
                        p.setString(3, r.getString("kd_barang"));
